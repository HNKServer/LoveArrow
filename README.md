...
Edit config.toml for the local path to ZH-CN data packs, generate honoka CN master DB (optional), run the server
...
在 config.toml 中添加国服本地数据包路径，生成 honoka CN master DB（可选），启动服务端
